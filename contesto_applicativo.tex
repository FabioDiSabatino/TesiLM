...
Utilizzando le differenti metodologie di stima della distanza viste precedentemente (vedi \ref{metodi_distanza}) si possono realizzare una moltitudine di algoritmi per stimare la posizione di un \textit{target} all'interno del sistema di riferimento. In questo paragrafo vengono illustrate le tecniche di posizionamento più conosciute e basilari utilizzate negli IPS.
