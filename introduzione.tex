...
\begin{description}
\item [Capitolo 1:] Viene descritto il problema della geolocalizzazione indoor e lo stato dell'arte.
\item [Capitolo 2:] Viene descritto il lavoro svolto con un approccio top down.
\item [Capitolo 3:] Vengono illustrate le tecnologie utilizzate (sensori MEMS e UWB) e le problematiche legate ad esse.
\item [Capitolo 4:] Viene descritto l'elaborazione dei dati grezzi e l'algoritmo di data fusion utilizzato.
\item [Capitolo 5:] Si riporta l'implementazione software e hardware dei sottosistemi.
